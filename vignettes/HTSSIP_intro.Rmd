...
* **Dataset exploration**
    * [Beta diversity ordinations of gradient fraction communities](beta_diversity_ordinations.Rmd)
    * [Whole-community BD shift plots](BD_shifts.Rmd)
* **Detecting incorporators**
    * [HR-SIP & MW-HR-SIP](MW_HR_SIP.Rmd)
    * [q-SIP](qSIP.html)
* **Calculating amount of incorporation**
    * [delta-BD](delta_BD.Rmd)
    * [q-SIP](qSIP.Rmd)
...
So to subset the data with phyloseq, we can use the `prune_samples()` function to subset the dataset:
